...
from common.util import get_class_func_name, TASK_OWN_THREADPOOL_SIZE
from event_listener import EXPIRE_ONCE
from job_unit import JobUnit, STATUS_FAIL, STATUS_ABORT
...
class TaskUnit(object):
    ...
    def __init__(self, task_sch, job_unit_seq, event=None, thread_pool=None, thread_pool_mutex=None, **params):
        ...
        if not thread_pool:
            self.thread_pool = threadpool.ThreadPool(TASK_OWN_THREADPOOL_SIZE)
