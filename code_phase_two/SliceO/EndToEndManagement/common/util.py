...
CONTEXT_NAMESPACE_SLICE_RES = 'slice resource'

#   event producer type involved
EVENT_PRODUCER_LOCAL_REST = 'local_rest_api'

#   event type involved
EVENT_TYPE_SLICE_RES_DEPLOY = 'slice_res_deploy_request'
EVENT_TYPE_SLICE_RES_INFO_ACQ = 'slice_res_info_acquire'

#   id namespace involved

#   job unit sequence involved
JOB_SEQ_SLICE_RES_DEPLOY = 'slice_res_deploy_job_seq'

#   remote service type involved
SERV_TYPE_VIM_DRIVER = 'vimDriver'
...
SERVICE_VNF_RES_DEPLOY = 'vnf_resource_deploy'
SERVICE_VNF_RES_ACQUIRE = 'vnf_resource_acquire'
