...
VNFC_RELATION_2_T = 'VNFC-RELATION-MME-SPGW'
VNFC_REL_2_S_VNFC_T_1 = VNFC2_T
VNFC_REL_2_S_VNFC_EP_1 = VNFC2_EP_1
VNFC_REL_2_T_VNFC_T_1 = VNFC1_T
VNFC_REL_2_T_VNFC_EP_1 = VNFC1_EP_1
...
#   vnf type id
VNF1_T = 'SPGW-VNF'
VNF2_T = 'SPGW-MME-HSS-VNF'

#   vnfc node
VNF1_VNFC_N_1 = 'SPGW-NODE'
VNF1_VNFC_N_1_T = VNFC1_T
VNF1_VNFC_N_2 = 'SPGW-NODE'
...
VNF2_VNFC_N_3 = 'SPGW-NODE'
VNF2_VNFC_N_3_T = VNFC1_T
...
VNF2_EP_3 = 'SPGW-ENDPOINT'
VNF2_EP_3_VNFC_N = VNF2_VNFC_N_3
VNF2_EP_3_VNFC_EP = VNFC1_EP_1
...
VNF2_CONNECT_2 = 'VNFC-CONNECTION-MME-SPGW'
VNF2_CONNECT_2_RELATION_T = VNFC_RELATION_2_T
VNF2_CONNECT_2_END_1 = VNF2_VNFC_N_1
VNF2_CONNECT_2_END_1_EP = VNFC2_EP_1
VNF2_CONNECT_2_END_2 = VNF2_VNFC_N_3
VNF2_CONNECT_2_END_2_EP = VNFC1_EP_1
...
VNF2_MAPPING_3 = 'MME-SPGW-ADDR-MAPPING'
VNF2_MAP_3_S_VNFC_N = VNF2_VNFC_N_1
VNF2_MAP_3_S_VNFC_N_PROP = VNFC2_PROP_5
VNF2_MAP_3_T_VNFC_N = VNF1_VNFC_N_1
VNF2_MAP_3_T_VNFC_N_PROP = VNFC1_PROP_4
...
######### generate vnfc relationship type ##########
    ...
    def add_vnfc_relationship_2_type(self):
        vnfc_re2 = VnfcRelationshipType()
        vnfc_re2.set_vnfc_relationship_info(VNFC_RELATION_2_T, VNFC_REL_2_S_VNFC_T_1 + ':' + VNFC_REL_2_S_VNFC_EP_1 + 
                                                            '->' + VNFC_REL_2_T_VNFC_T_1 + ':' + VNFC_REL_2_T_VNFC_EP_1)
        vnfc_re2.set_source_end(VNFC_REL_2_S_VNFC_T_1, VNFC_REL_2_S_VNFC_EP_1)
        vnfc_re2.set_target_end(VNFC_REL_2_T_VNFC_T_1, VNFC_REL_2_T_VNFC_EP_1)
        self.vnfc_relationship_types[VNFC_RELATION_2_T] = vnfc_re2


    def add_vnfc_relationship_types(self):
        self.add_vnfc_relationship_1_type()
        self.add_vnfc_relationship_2_type()
...
######### generate vnf type ##########
    ...
    def add_vnf2_type(self):
        ...
        vnf_t.add_connection(VNF2_CONNECT_2, VNF2_CONNECT_2_RELATION_T, 
                             VNF2_CONNECT_2_END_1, VNF2_CONNECT_2_END_1_EP,
                             VNF2_CONNECT_2_END_2, VNF2_CONNECT_2_END_2_EP)
        ...
        vnf_t.add_vnfc_property_mapping(VNF2_MAPPING_2, VNF2_MAP_2_S_VNFC_N, VNF2_MAP_2_S_VNFC_N_PROP, 
                                                        ...
                                                        VNF2_MAPPING_1_MUL_INST_OPT)
        vnf_t.add_vnfc_property_mapping(VNF2_MAPPING_3, VNF2_MAP_3_S_VNFC_N, VNF2_MAP_3_S_VNFC_N_PROP, 
                                                        VNF2_MAP_3_T_VNFC_N, VNF2_MAP_3_T_VNFC_N_PROP, 
                                                        VNF2_MAPPING_1_MUL_INST_OPT)
...
########## generate ns flavor design ############
    ...
    def add_ns_flavor_design(self):
        ns_f = NsFlavorDesign()
        ns_f.add_vnfc_deploy_flavor(NS_VNF_N_2, VNF2_VNFC_N_3, 'openstack','m1.large','spgw')
#        ns_f.add_vnfc_deploy_flavor(NS_VNF_N_1, VNF1_VNFC_N_2)
 ...
 #       ns_f.add_vnfc_deploy_flavor(NS_VNF_N_2, VNF2_VNFC_N_3)
        ...
        ns_f.add_vnfc_config_flavor(NS_VNF_N_2, VNF2_VNFC_N_3, VNFC1_PROP_5, NS_F_VNFC_CONF_VALUE_1)
        ns_f.add_vnfc_config_flavor(NS_VNF_N_2, VNF2_VNFC_N_3, VNFC1_PROP_4, NS_F_VNFC_CONF_VALUE_6)
