...
if 'ns_combo_design_files' not in os.listdir(MAIN_DIR):
    os.mkdir('ns_combo_design_files')
...
NS_VNF_N_1 = 'SPGW-MME-HSS-NODE'
#NS_VNF_N_2 = 'SPGW-NODE'

############ NS COMBO FLAVOR DESIGN ###########

#   basic info
NS_COMBO_FLAVOR = 'vEPC-SERVICE'
NS_COMBO_FLAVOR_DESC = NS_COMBO_FLAVOR

#   sub ns flavors
SUB_NS_1 = 'vEPC-SUBNS-1'
SUB_NS_1_T = NS_T
SUB_NS_1_F = NS_F
...
#   endpoints
ENDPOINT_1 = 'vEPC-SUBNS-1-ENDPOINT'
